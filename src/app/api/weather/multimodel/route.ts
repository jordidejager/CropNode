...
import { getMultiModelForecast } from '@/lib/weather/weather-service';

/**
 * GET /api/weather/multimodel?stationId=X
 * Returns forecast data from all 5 weather models, grouped per model.
 */
