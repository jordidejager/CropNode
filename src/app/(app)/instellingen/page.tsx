  ...
  return (
    <div className="max-w-2xl mx-auto pb-12">
      ...
      <div className="space-y-4">
        ...
        <Link
          href="/instellingen/claude"
          className="block rounded-2xl border border-white/[0.06] bg-white/[0.02] p-5 hover:bg-white/[0.04] transition-colors"
        >
          <div className="flex items-center gap-3">
            <Sparkles className="h-4 w-4 text-emerald-400" />
            <div className="flex-1">
              <h2 className="text-sm font-semibold text-white/80">Claude-koppeling</h2>
              <p className="text-xs text-white/25 mt-0.5">Praat in Claude met je spuitschrift, percelen, weer en notities</p>
            </div>
            <ArrowRight className="h-4 w-4 text-white/40" />
          </div>
        </Link>
