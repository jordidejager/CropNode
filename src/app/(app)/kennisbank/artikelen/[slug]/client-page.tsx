...
function RelatedTopics({ topic, allTopics, products }: { topic: Topic; allTopics: RelatedTopic[]; products: Product[] }) {
  ...
  return (
    <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-3">
      {related.map(t => (
        <Link key={t.slug} href={`/kennisbank/artikelen/${t.slug}`}>
      ...
      <div className="border-b border-emerald-500/10 bg-card/30 backdrop-blur-sm">
        <div className="p-4 md:p-6 max-w-7xl">
          ...
          <div className="flex items-center gap-2 text-xs text-muted-foreground mb-3">
            <Link href="/kennisbank/artikelen" className="hover:text-emerald-400 transition-colors flex items-center gap-1">
