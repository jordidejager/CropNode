...
export const wegwijzerSections: WegwijzerSection[] = [
  ...
  },
  {
    ...
    wat: 'Beheer al je percelen, blokken en boomgaarden. De basis van al je registraties. Zonder percelen kan de rest van het platform niet werken.',
    hoeWerktHet: [
    ...
    voorbeeld: 'Perceel toevoegen:\n\u2022 Naam: "Luisweg" \u2192 Gewas: Peer \u2192 Ras: Conference \u2192 Oppervlakte: 2.5 ha\n\u2022 Naam: "Achter de schuur" \u2192 Gewas: Appel \u2192 Ras: Elstar \u2192 Oppervlakte: 1.8 ha\n\nDaarna kun je in Slimme Invoer typen: "Luisweg gespoten met Captan" en het systeem weet precies welk perceel je bedoelt.',
    tips: [
      ...
      'Je kunt percelen groeperen op ras of locatie',
    ],
    samenhang: [
    ...
    keywords: ['percelen', 'blokken', 'boomgaard', 'gewas', 'ras', 'oppervlakte', 'hectare'],
    route: '/parcels/list',
  },
  {
    id: 'spuitschrift',
